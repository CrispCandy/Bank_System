    ...
    <div class = "login-box">
      <div>
        <div class="box-header">
          <img class="logo" src="../assets/bankLogo.png" alt="" />
          <div class="title">银行管理系统 - 登录</div>
        </div>
        <a-tabs v-model:activeKey="activeKey" centered>
          <a-tab-pane key="1" tab="密码登录">
              <a-input v-model:value="form.email" size="large" style="margin-top: 10px" placeholder="邮箱">
                <template #prefix>
                  <mail-outlined />
                </template>
                <template #suffix>
                  <a-tooltip title="请输入正确的邮箱格式！">
                    <info-circle-outlined style="color: rgba(0, 0, 0, 0.45)" />
                  </a-tooltip>
                </template>
              </a-input>
            <a-input-password v-model:value="form.password" size="large" style="margin-top: 20px" placeholder="密码">
            <template #prefix>
              <lock-outlined />
            </template>
              </a-input-password>
          ...
          <a-tab-pane key="2" tab="验证码登录" force-render>
            <a-input v-model:value="form.email" size="large" style="margin-top: 10px" placeholder="邮箱">
              ...
              <template #suffix>
                <a-tooltip title="请输入正确的邮箱格式！">
                  <info-circle-outlined size="large" style="color: rgba(0, 0, 0, 0.45)" />
                </a-tooltip>
              </template>
            </a-input>
            <div style="display: flex">
            <a-input v-model:value="form.code" style="margin-top: 20px" aria-placeholder="验证码">
              <template #prefix>
                <SafetyCertificateOutlined />
              </template>
            </a-input>
            <a-button style="margin-top: 20px" class="code-btn" :loading="sendLoading" @click="sendEmail">
              获取验证码
            </a-button>
              </div>
          </a-tab-pane>
        </a-tabs>
        <a-button style="margin-top: 20px" :loading="submitLoading" class="submit-btn" type="primary" @click="submitLogin">
          确认登陆
        </a-button>
...
//           }
//           else if(res.data.admin.roles === 'ROLE_DRIVER')
//           {
//             let access = 1
//             sessionStorage.setItem('access', access)
//           }
...
//             sessionStorage.setItem('access', access)
//           }
//           else if(res.data.admin.roles === 'ROLE_COMMODITY')
//           {
//             let access = 3
//             sessionStorage.setItem('access', access)
//           }
//           else if(res.data.admin.roles === 'ROLE_EMPLOYEE')
//           {
//             let access = 4
//             sessionStorage.setItem('access', access)
//           }
//           else if(res.data.admin.roles === 'ROLE_ANALYZE')
//           {
//             let access = 5
//             sessionStorage.setItem('access', access)
//           }
//           else if(res.data.admin.roles === 'ROLE_WAREHOUSE')
//           {
//             let access = 6
//             sessionStorage.setItem('access', access)
//           }
...
//               if (access == 0) { this.$router.push("/sadmin/admin"); console.log("Access:"+0) }
//               else if(access == 1) { this.$router.push("/driver/delivery/list"); console.log("Access:"+1) }
//               else if(access == 2) { this.$router.push("/user/delivery/create"); console.log("Access:"+2) }
//               else if(access == 3) { this.$router.push("/commodity/commodity"); console.log("Access:"+3) }
//               else if(access == 4) { this.$router.push("/empl/employee"); console.log("Access:"+4) }
//               else if(access == 5) { this.$router.push("/anal/analyze/in"); console.log("Access:"+5) }
//               else if(access == 6) { this.$router.push("/ware/warehouse"); console.log("Access:"+6) }
//               else{this.$router.push("/user/delivery/create"); console.log("Access"+access)}
